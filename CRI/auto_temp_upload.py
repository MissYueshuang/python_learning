...
import numpy as np
from auto_send_email import sent_email_from_outlook_text
...
sent_email_from_outlook_text('auto temp upload','体温已经上传啦~~')
...
sent_email_from_outlook_text('auto temp upload','现女友： 李现哥哥，体温已经帮你上传啦~~',['ephgh@nus.edu.sg'])
