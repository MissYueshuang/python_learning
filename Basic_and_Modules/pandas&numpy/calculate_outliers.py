# -*- coding: utf-8 -*-
"""
Created on Fri Feb  7 11:24:00 2020

@author: rmileng
"""

# lesson 7: calculate outliers
...
# Combine dataframes
df = pd.concat([df1,df2]) # by row

# method 1 
newdf = df.copy()
newdf['x-Mean'] = abs(newdf['Revenue']-newdf['Revenue'].mean()) #mean
newdf['1.96*std'] = 1.96*newdf['Revenue'].std() # std()
...
newdf['Mean'] = State.transform( lambda x: abs(x.mean()) )
