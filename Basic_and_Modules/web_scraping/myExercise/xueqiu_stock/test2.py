# -*- coding: utf-8 -*-
"""
Created on Tue Feb 11 14:41:32 2020
...
#        tasks = [loop.create_task(eachpage2(url,session,headers)) for url in urls]
#        finished, unfinished = await asyncio.wait(tasks)
#        all_results = [r.result() for r in finished]    # 获取所有结果
#        print(all_results)
    tasks = [loop.create_task(eachpage2(url,headers)) for url in urls]
...
loop.run_until_complete(main(urls,headers))         # 执行 loop
loop.close()                                # 关闭 loop
